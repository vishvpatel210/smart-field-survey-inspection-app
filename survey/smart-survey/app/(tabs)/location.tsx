        ...
        {location && (
          <>
            <View style={styles.mapPlaceholder}>
              <Ionicons name="map" size={48} color={AppColors.primaryLight + '30'} />
              <Text style={styles.mapText}>Location Coordinates</Text>
            </View>

            <View style={styles.coordinatesCard}>
              <View style={styles.coordHeader}>
                <Ionicons name="navigate" size={20} color={AppColors.primaryLight} />
            ...
            <View style={styles.coordinatesCard}>
              <View style={styles.coordHeader}>
                <Ionicons name="stats-chart" size={20} color={AppColors.primaryLight} />
                <Text style={styles.coordTitle}>Signal & Time</Text>
              </View>
              <View style={styles.divider} />
                ...
                <View style={styles.detailItem}>
                  <View style={styles.detailText}>
                    ...
                    <Text style={styles.detailValue}>
                      {location.accuracy ? `${location.accuracy.toFixed(1)} meters` : 'N/A'}
                    </Text>
                  </View>
                </View>
                <View style={styles.detailItem}>
                  <View style={styles.detailText}>
                    <Text style={styles.detailLabel}>Captured Time</Text>
              ...
              <View style={styles.fullCopyCard}>
                <View style={styles.copyRow}>
                  <Ionicons name="document-text-outline" size={18} color={AppColors.gray500} />
            ...
            <View style={styles.actions}>
              ...
              >
                {loading ? (
                  ...
                  <Ionicons name="refresh" size={22} color={AppColors.primaryLight} />
                )}
...
const styles = StyleSheet.create({
  ...
  mapPlaceholder: {
    ...
    justifyContent: 'center',
    borderWidth: 1.5,
    borderColor: AppColors.primaryLight + '20',
    borderStyle: 'dashed',
  },
  mapText: {
    fontSize: 14,
    color: AppColors.primaryLight + '60',
    marginTop: 8,
    fontWeight: '500',
  },
  coordinatesCard: {
